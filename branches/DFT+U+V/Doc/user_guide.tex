...
of the various variables. Note thaty ou may need 
...
instructions. 
\item {\bf TO BE CHANGED} To run a single example, go to the corresponding directory (e.g.
...
with multithreaded libraries. BEWARE: you have to be 
