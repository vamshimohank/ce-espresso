  ...
  CONTAINS
    ...
    SUBROUTINE read_property ( attr_in)
      ...
      CASE ( 'starting_magnetization' )
         ...
         !
      CASE ( 'hubbard_alpha' )
         CALL iotk_scan_dat_inside( xmlinputunit, hubbard_alpha( is, 0:lmaxx ),&
              ierr = ierr)
         !
      CASE ( 'hubbard_beta' )
         CALL iotk_scan_dat_inside( xmlinputunit, hubbard_beta( is, 0:lmaxx ),&
              ierr = ierr)
         !
      CASE ( 'hubbard_u' )
         CALL iotk_scan_dat_inside( xmlinputunit, hubbard_u( is, 0:lmaxx, 0:lmaxx ),&
              ierr = ierr)
         !
