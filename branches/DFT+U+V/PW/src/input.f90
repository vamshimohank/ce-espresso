...
SUBROUTINE iosys()
  ...
  !
  Hubbard_U_(1:ntyp,0:lmaxx,0:lmaxx)      = hubbard_U(1:ntyp,0:lmaxx,0:lmaxx)
  Hubbard_alpha_(1:ntyp,0:lmaxx) = hubbard_alpha(1:ntyp,0:lmaxx)
  Hubbard_beta_(1:ntyp,0:lmaxx)  = hubbard_beta(1:ntyp,0:lmaxx)
  lda_plus_u_             = lda_plus_u
  la2F_                   = la2F
  nspin_                  = nspin
  starting_magnetization_ = starting_magnetization
