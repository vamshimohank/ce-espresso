...
MODULE pw_restart
  ...
  CONTAINS
    ...
    SUBROUTINE pw_writefile( what )
      ...
      USE ldaU,                 ONLY : lda_plus_u, Hubbard_U, Hubbard_alpha, Hubbard_beta
    ...
    SUBROUTINE read_xc( dirname, ierr )
      ...
      IF ( ionode ) THEN
         ...
         IF ( lda_plus_u ) THEN
            ...
            CALL iotk_scan_dat( iunpun, "HUBBARD_U", Hubbard_U(1:nsp_,0:lmaxx,0:lmaxx) )
            CALL iotk_scan_dat( iunpun, "HUBBARD_ALPHA", Hubbard_alpha(1:nsp_,0:lmaxx) )
            CALL iotk_scan_dat( iunpun, "HUBBARD_BETA", Hubbard_beta(1:nsp_,0:lmaxx) )
            !
         END IF
